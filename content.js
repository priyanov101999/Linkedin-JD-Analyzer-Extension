...
function extractFromElement(element) {
  ...
  const mentionsCitizenship = fullText.toLowerCase().includes("citizenship");

  return {
    years: foundYears,
    tech: foundTech,
    citizenship: mentionsCitizenship ? "Mentioned" : "Not mentioned"
  };
}
...
function updateJDBox() {
  ...
  container.innerHTML = `<strong>JD Summary:</strong><br>
    ...
    <strong>Tech Stack:</strong> ${result.tech.join(", ") || "Not found"}<br>
    <strong>Citizenship:</strong> ${result.citizenship}`;
}
